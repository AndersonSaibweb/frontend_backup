...
class Table {
    ...
    changeFilters() {
        ...
        let options = document.getElementsByClassName('select2 select2-hidden-accessible')[0].options
        ...
        let optionsSelected = document.getElementsByClassName('select2 select2-hidden-accessible')[0].selectedOptions
                        ...
                        'createdRow': function (row, data, dataIndex) {
                            ...
                            indexRow.forEach((item, index) => {
                                ...
                                if (item != 'DATA' &&
                                    ...
                                    item != 'COD_CLI' &&
                                    item != 'CLIENTE') {
                                    $('td', row).eq(index).html(parseFloat($('td', row).eq(index).html()).toLocaleString())
                                }

                                if (item == 'VLR_NOTA') {
                                    $('td', row).eq(index).html(parseFloat($('td', row).eq(index).html().replace('.', '')).toLocaleString('pt-br', { style: 'currency', currency: 'BRL' }))
                                }

                                if (item == 'DATA') {
                                    if (getDiffDates($('td', row).eq(index).html()) >= 30) {
                                        $('td', row).eq(index).css("background-color", "#F9A8A8");
                                    }
                                    $('td', row).eq(index).html(getDataFormatada($('td', row).eq(index).html()).substring(0, 10))
                                }
                                ...
                                if (item == 'REPRESENTANTE' ||
                                    ...
                                    $('td', row).eq(index).html($('td', row).eq(index).html().substr(0, 35))
                                }
